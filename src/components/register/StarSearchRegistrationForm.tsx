...
const getImageSrcByViewportSize = (width: number) => {
  if (width >= VIEW_PORT_SIZES.md) {
    return '/botb/ss_regis_lg.png';
  }
  if (width >= VIEW_PORT_SIZES.sm) {
    return '/botb/ss_regis_md.png';
  }

  return '/botb/ss_regis_sm.png';
};
        ...
        <div className="flex xl:flex-row flex-col xl:gap-12 justify-center items-start mt-12">
          <div className="flex justify-center md:mt-0 px-4 xl:w-fit w-full">
            <div className="flex flex-col gap-4 justify-center">
              <div className="flex flex-col gap-2 p-4 border-2 rounded-xl `md:w-[40rem]">
                ...
                <div className="flex gap-4 md:pl-8 flex-col">
                  <div className="flex flex-col w-full">
                    ...
                    <p>September 28, 2024 | 11:00 AM - 3:00 PM</p>
                  </div>
                  <div className="flex flex-col w-full">
                    <h3 className="font-bold">Venue</h3>
                    <p>
                      Bapa Benny Tudtud Auditorium, Ateneo de Davao University
                    </p>
                  </div>
                </div>
              </div>
